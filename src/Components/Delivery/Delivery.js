...
const Delivery = () => {
    return (
        <div className="page__delivery _container">
            <h2 className="page__delivery__title">Оплата и доставка</h2>
            <h3 className="delivery__subtitle">Доставка</h3>
            <div className="row">
                <ol className="list__item">
                    <li className="item">По всей России отправляем компаниями "Сдэк", "Пэк", "Деловые линии", "Байкал сервис"
                        или другой ТК по индивидуальной договорённости.</li>
                    <li className="item">По Санкт-Петербургу бесплатно курьерской службой "Достависта", "Яндекс такси" или до ПВЗ "Сдэк"</li>
                    <li className="item">Вам приходит смс с контактами курьера перед доставкой!</li>
                </ol>
